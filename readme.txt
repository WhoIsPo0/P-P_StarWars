# STAR WARS
![header photo](https://github.com/WhoIsPo0/P-P_StarWars/blob/main/readme%20pics/header%20photo.png)
...
after picking what you want to do you then move by wasd keys and attack to left and right by l and r keys.
